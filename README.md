...
4. Click **Start Exercise**. Follow the step-by-step instructions and feedback will be provided as you progress.
   ...
   <a id="start-exercise" href="https://github.com/Krishna7141/skills-build-copilot-app/issues/1" href="https://github.com/Premravva/skills-build-applications-w-copilot-agent-mode/issues/1">
